...
ここで重要なのは「分からないことで悩んでも意味がない」ということではありません。悩んでも意味がないのはそうなんですが、不確実性はネガティブなものではなく、もっと歓迎すべきものなのだと考えています。プロジェクト管理やプロダクトマネジメントは、不確実性を突き止めて確定させるゲームなのです。自分が不出来だから分かんないんだと思ってたけど、そうじゃない。
