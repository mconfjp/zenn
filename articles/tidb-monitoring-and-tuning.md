...
*トップページでメトリクスを選択すると出てくるポップアップ。メトリクスの種類が選べます*
...
一応整理してみましたが、メトリクスの数が多く、TiDBの内部構造に精通していないと理解が難しいものもあり、使いこなすのは簡単ではなさそうです。ただ、メトリクスは問題の検知をする上で最も重要なため、もう少し容易にメトリクスを確認できるインターフェースがほしいと感じました。
...
弊社環境では最大２週間を遡ることができ、どんなスロークエリが出ていたか確認できました。クエリごとに表示される項目はpt-query-digestと同じ^[たぶん]であり、MySQLでスロークエリを見ていた人間にとってはとっつきやすいものでした。
