...
*トップページでメトリクスを選択すると出てくるポップアップ。メトリクスの種類が選べます。なおdegaultとなっている箇所は利用しているTiDBのバージョンを選択する必要があります。*
...
### ベンチマークレポート
![](https://storage.googleapis.com/zenn-user-upload/5362c21ae7c9-20260205.png)
